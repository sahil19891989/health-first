...
| `Health_First_Week6_Pitch.pptx` | Week 6 pitch deck — 8 slides: problem, why typical apps fail, solution, architecture diagram, wider impact, proof it's real + links, and close. |
